...
- Citizens: 0 considered -- `users.ward` is confirmed unused for the citizen role (see docs/archive/location_data_audit.md §2), so there is nothing to migrate for citizens in this pass.
